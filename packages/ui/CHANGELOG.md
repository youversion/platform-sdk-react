...
- 81690b5: Add Bible Reader search: one USFM grammar, an exclusive-lane `useBibleSearch` session, and a Toolbar-mounted `BibleReaderSearch` that navigates with transient verse focus.
...
- be82d6d: Make `YouVersionAuthButton` honor explicit and default sign-in modes for authenticated users.
...
- 1a79aeb: Sync localization from platform-localization (f96d5b4): update 2 keys in en.
...
- Updated dependencies [0ae2488]
  ...
  - @youversion/platform-react-hooks@2.11.0
